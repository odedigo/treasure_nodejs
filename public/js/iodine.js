...
export default class Iodine
{
    ...
    constructor()
    {
        ...
        this.messages = {
            ...
            email         : "יש להזין כתובת אימייל חוקית",
            falsy         : "[FIELD] must be a falsy value (false, 'false', 0 or '0')",
            in            : "[FIELD] must be one of the following options: [PARAM]",
            integer       : "השדה צריך להיות מספר שלם",
            json          : "[FIELD] must be a parsable JSON object string",
            max           : "הערך צריך לניות קטן או שווה ל [PARAM]",
            min           : "הערך צריך להיות גדול או שווה ל [PARAM]",
            maxLength     : "הערך צריך להכיל מקסימום '[PARAM]' תווים",
            minLength     : "השדה חייב להכיל לפחות '[PARAM]' תווים",
            ...
            required      : "השדה לא יכול להיות ריק",
